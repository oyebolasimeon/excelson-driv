    ...
    <div class="pcoded-main-container">
                    ...
                    <div class="row">
					 ...
					 include ("../headerFiles/connection.php");
						...
						?></h4>
                                ...
                                <a href="video_resources.php"> <div class="card-footer bg-c-green">
                                    <div class="row align-items-center">
                                        <div class="col-9">
					 ...
					 include ("../headerFiles/connection.php");
						...
						?></h4>
                                ...
                                <a href="subscribers.php">      <div class="card-footer bg-c-red">
                                    <div class="row align-items-center">
                                        <div class="col-9">
                                            <p class="text-white m-b-0">View More</p>
                                        </div>
                        ...
                        <div class="col-sm-3">
                            <div class="card">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        <div class="col-8">
                                            <h4 class="text-c-blue"><?php
					 include ("../headerFiles/connection.php");
                                        $sql= "SELECT count(id) as total from landmarks";
                                        $result = mysqli_query($db_connect, $sql);
                                        $values = mysqli_fetch_assoc($result);
                                        $num_row = $values['total'];
                                        echo $num_row;		
						...
						?></h4>
                                            <h6 class="text-muted m-b-0">Landmarks </h6>
                                        </div>
                                        <div class="col-4 text-right">
                              ...
                              <a href="landmark.php">  <div class="card-footer bg-c-blue">
                                    <div class="row align-items-center">
                                        <div class="col-9">
                                            <p class="text-white m-b-0">View More</p>
                                        </div>
		...
		?>
                            ...
                            <div class="text-center">
                                <a href="subscribers.php" class="b-b-primary text-primary">View all Mail</a>
                            </div>
                        </div>
                    </div>
                </div>
